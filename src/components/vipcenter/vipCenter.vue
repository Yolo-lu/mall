  ...
  <div>
    ...
    <div class="container">
      <div class="list" @click="compeleted">
        <div>
          <span><van-icon name="records" size="25px"/></span
      ...
      <div class="list" @click="collection">
        <div>
          <span><van-icon name="star-o" size="25px"/></span
          ><span class="text">收藏管理</span>
        </div>
        <div><van-icon name="arrow" size="20px" /></div>
      </div>
      <div class="list" @click="address">
        <div>
          <span><van-icon name="points" size="25px"/></span
      ...
      <div class="list" @click="watched">
        <div>
          <span><van-icon name="eye-o" size="25px"/></span
